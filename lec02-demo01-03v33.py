...
cfl = 0.5   # Courant condition factor

# Available schemes, error types and functions
scheme_color = [ 'r', 'orange', 'g', 'brown', 'b', 'm']
...
scheme_err_plot = [0,1,2,3,4,5]	# SELECT the scheme(s) that displays in the error-vs-time plot {0,1,2,3,4}
...
# plotting parameters
end_time        = 12.0 * period  # simulation time
