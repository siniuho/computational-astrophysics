...
#--------------------------------------------------------------------
# Simulate acoustic wave with the Lax-Wendroff scheme
#--------------------------------------------------------------------
...
#--------------------------------------------------------------------
# constants
L        = 10.0       # 1-D computational domain size
...
def ref_func( x, t ):
   ...
   Phase = WaveK*x - WaveW*t  # wave phase kx - ωt
...
fig.suptitle( 'acoustic wave / Lax-Wendroff scheme' )
